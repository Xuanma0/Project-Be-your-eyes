...
- HEAD: release commit for `v5.08.2` hotfix; use `git rev-parse HEAD` for the exact current value.
- `VERSION`: `v5.08.2`
- Unity editor target: `6000.3.10f1`
- Enabled build scene: `Assets/Scenes/Quest3SmokeScene.unity`
- Preferred Quest launcher: `tools/quest3/quest3_usb_realstack_v5_08_2.cmd`
- Compatibility wrapper: `tools/quest3/quest3_usb_realstack_v5_08.cmd`
...
- In the `v5.08.2` hotfix band, prioritize fail-closed real bring-up and Quest UX stabilization over new features: launcher preflight honesty, provider evidence, overlay asset lifecycle, passthrough fallback honesty, and hand-menu/controller usability outrank new capability work.
...
- Run `tools\quest3\quest3_usb_realstack_v5_08_2.cmd --preflight-only` first when debugging why a provider is unavailable.
